export default class RainbowTableService {
    ...
    static getSearchListQueryString(
        pageNumber,
        limit,
        sortKey,
        includeNotFound
    ...
    getRainbowTables(pageNumber, limit, sortKey) {
        return new Promise((resolve) => {
            this.http.ajax({
                type: "GET",
                url: `/api/rainbow-table${RainbowTableService.getListQueryString(
                    pageNumber,
                    limit,
                    sortKey
                )}`,
    ...
    getRainbowTableSearches(
        ...
        let queryString = RainbowTableService.getSearchListQueryString(
            pageNumber,
            limit,
            sortKey,
            includeNotFound
