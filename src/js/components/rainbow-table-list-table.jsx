...
export default class RainbowTableListTable extends DynamicListEntityTable {
    ...
    static getRainbowTableLink(rainbowTable) {
        return (
            <a href={`/search-rainbow-table?rainbowTableId=${rainbowTable.id}`}>
                {rainbowTable.name}
            </a>
        );
    }
        ...
        return [
            {
                ...
                accessor: "name",
                Cell: (row) =>
                    RainbowTableListTable.getRainbowTableLink(row.original)
            },
            {
                Header: "Status",
            ...
            },
            {
                Header: "Progress",
                Cell: (row) =>
                    RainbowTableListTable.getProgressBar(row.original),
                sortable: false
            },
            { Header: "Num Chains", accessor: "numChains" },
            {
                Header: "Chains Generated",
                accessor: "chainsGenerated",
                sortable: false
            },
